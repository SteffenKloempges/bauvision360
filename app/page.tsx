...
import ImageSachverstaendiger from "@/images/services/Bausachverstaendigung.webp";
      ...
      <section className="py-24 px-5">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <FadeIn>
              <Link
                href="/services/sachverstaendigung"
                className="block bg-white rounded-lg shadow-lg hover:-translate-y-1 transition-transform overflow-hidden group h-full"
              >
                <div className="relative w-full h-72">
                  <Image
                    src={ImageSachverstaendiger}
                    layout="fill"
                    alt="Hier sieht man eine Koordinierende Bauleistung"
                    objectFit="cover"
                  />
