const Impressum = () => {
    return <main className="px-4 max-w-screen-xl mx-auto py-8 prose prose-slate">
        <h1 className="text-3xl font-bold mb-8">Impressum</h1>

        <p className="mb-4">Marcel Lenckowski<br />
            BAUVISION360<br />
        ...
        <h2 className="text-2xl font-semibold mb-4">Verbraucher&shy;streit&shy;beilegung/Universal&shy;schlichtungs&shy;stelle</h2>
        ...
        <p className="mb-4">Quelle: <a href="https://www.e-recht24.de" className="text-blue-600 hover:text-blue-800">e-recht24.de</a></p>
    </main>
}
